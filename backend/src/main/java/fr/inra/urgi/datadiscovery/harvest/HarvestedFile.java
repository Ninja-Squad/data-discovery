...
public final class HarvestedFile {
    ...
    /**
     * The number of documents in the file that have been successfully stored in ElesticSearch
     */
    ...
    public static final class HarvestedFileBuilder {
        ...
        /**
         * Adds a success, i.e. records a success for one of the documents stored in the file
         */
        ...
        /**
         * Adds N successes, i.e. records a success for N of the documents stored in the file
         */
        ...
        /**
         * Adds an error, i.e. records an error for one of the documents stored in the file
         * @param index the index of the document for which the error happened
