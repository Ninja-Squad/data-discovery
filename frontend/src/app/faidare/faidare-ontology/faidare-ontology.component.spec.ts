...
describe('OntologyComponent', () => {
  ...
  describe('once initialized', () => {
    ...
    test('should keep the tree state while changing the language', async () => {
      ...
      await expect.element(tester.tree).toMatchTextContent('Hola TC1');
      await expect.element(tester.highlightedNode).toMatchTextContent('Hola TC1');
      await expect.element(tester.nodeDetails).toMatchTextContent('Hola TC1');
    });
  });
});
